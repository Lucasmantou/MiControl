...
mod windows_impl {
    ...
    const VALUE_NAME: &str = "MiControl";
    ...
    mod tests {
        ...
        fn command_target_reads_quoted_and_bare_forms() {
            assert_eq!(
                command_target("\"C:\\MiControl\\MiControl.exe\""),
                "C:\\MiControl\\MiControl.exe"
            );
            assert_eq!(
                command_target("\"C:\\MiControl\\MiControl.exe\" --minimized"),
                "C:\\MiControl\\MiControl.exe"
            );
            assert_eq!(
                command_target("C:\\MiControl\\MiControl.exe"),
            ...
            assert_eq!(command_target("  \"C:\\MiControl\\MiControl.exe\"  "), "C:\\MiControl\\MiControl.exe");
        ...
        fn command_matches_current_executable_ignoring_case_and_separators() {
            let executable =
                Path::new("C:\\Users\\Administrator\\AppData\\Local\\MiControl\\MiControl.exe");
            assert!(command_targets_executable(
                "\"C:\\Users\\Administrator\\AppData\\Local\\MiControl\\MiControl.exe\"",
                executable
            ));
            assert!(command_targets_executable(
                "\"c:\\users\\administrator\\appdata\\local\\micontrol\\micontrol.EXE\"",
        ...
        fn command_from_other_install_path_is_not_enabled() {
            ...
            assert!(!command_targets_executable("\"\"", executable));
            assert!(!command_targets_executable(
                "\"D:\\old\\MiControl\\MiControl.exe\"",
                executable
            ));
            assert!(!command_targets_executable("MiControl.exe", executable));
        }
