export type PageId = "buttons" | "settings";

export type NavIcon = "keyboard" | "settings";
...
export const navigationItems: NavigationItem[] = [
  { id: "buttons", label: "配置按键", icon: "keyboard" },
  { id: "settings", label: "设置", icon: "settings" },
];

const ACTIVE_PAGE_STORAGE_KEY = "micontrol.activePage";
const LIVENESS_STORAGE_KEY = "micontrol.livenessHeartbeat";
