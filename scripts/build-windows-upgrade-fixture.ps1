...
$overridePath = Join-Path $env:RUNNER_TEMP "micontrol-predecessor-tauri-config.json"
...
$fixturePath = Join-Path $fixtureDirectory "micontrol-predecessor-$predecessorVersion-setup.exe"
